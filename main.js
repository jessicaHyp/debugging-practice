if(typeof window !== "undefined"){
  ...
  console.log(deckElement.classList)
  console.log(deckElement.querySelector('.child'))
  
  console.log(deckElement.className)
  var deckColorHash = window.location.hash;
  console.log(deckColorHash)


  if (deckColorHash && deckElement) {
    let deckColor = deckColorHash.replace("#","")
    var className = '--'+deckColor;
